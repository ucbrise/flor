...
# sys.path.insert(0, os.path.abspath('./flor'))
...
latex_documents = [
    (master_doc, "flor.tex", "flor Documentation", "UC Berkeley, RISE Lab", "manual"),
]
...
man_pages = [(master_doc, "flor", "flor Documentation", [author], 1)]
