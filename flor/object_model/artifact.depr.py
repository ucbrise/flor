...
from flor import above_ground as ag
from flor.stateful import State
from flor.object_model.recursivesizeof import total_size
...
class Artifact:
    ...
    def pull(self, manifest={}):
        # TODO: LEAVE INTERFACE HERE, MOVE WORK TO ENGINE
        ...
        # ag.pull(self.xp_state, self.loc) #TODO: change this back potentially
    ...
    def peek(self, head=25, manifest={}, bindings = {}, func = lambda x: x):
        ...
        with tempfile.TemporaryDirectory() as tmpexperiment:
            ...
            ag.peek(self.xp_state, self.loc)
            return out
